...
require_variables "MOD_ID" "ENGINE_DIRECTORY" "PACKAGING_DISPLAY_NAME" "PACKAGING_INSTALLER_NAME" \
	...
	"PACKAGING_OVERWRITE_MOD_VERSION" "PACKAGING_WINDOWS_DEPENDENCY_FILES"
...
function build_platform()
{
	...
	for d in ${PACKAGING_WINDOWS_DEPENDENCY_FILES}; do
		cp -r "${d}" "${BUILTDIR}/${d}"
	done
