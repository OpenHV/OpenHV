...
namespace OpenRA.Mods.HV.Traits
{
	...
	public class CustomBaseBuilderBotModuleInfo : ConditionalTraitInfo
	{
		...
		public override object Create(ActorInitializer init) { return new CustomBaseBuilderBotModule(init.Self, this); }
	}
		...
		IBotTick, IBotPositionsUpdated, IBotRespondToAttack, IBotRequestPauseUnitProduction
	{
		...
		readonly List<CustomBaseBuilderQueueManager> builders = new List<CustomBaseBuilderQueueManager>();
		...
		protected override void TraitEnabled(Actor self)
		{
			foreach (var building in Info.BuildingQueues)
				builders.Add(new CustomBaseBuilderQueueManager(this, building, player, playerPower, playerResources, resourceLayer));
			foreach (var defense in Info.DefenseQueues)
				builders.Add(new CustomBaseBuilderQueueManager(this, defense, player, playerPower, playerResources, resourceLayer));
		}
