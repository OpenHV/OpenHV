...
namespace OpenRA.Mods.Common.Widgets
{
	...
	public class CustomCommandBarLogic : ChromeLogic
	{
		...
		public CustomCommandBarLogic(Widget widget, World world, Dictionary<string, MiniYaml> logicArgs)
		{
			this.world = world;
		...
		void UpdateStateIfNecessary()
		{
			...
			attackMoveDisabled = !selectedActors.Any(a => a.Info.HasTraitInfo<AutoDeployInfo>() || a.Info.HasTraitInfo<AttackMoveInfo>() && a.Info.HasTraitInfo<AutoTargetInfo>());
